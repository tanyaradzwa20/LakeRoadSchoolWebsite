<x-app>
    <x-breadcrumb class="breadcrumb-height breadcumb-bg" image="breadcrumb.jpg" title="Alumni" page="Alumni" />
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="rts__section--wrapper v__9">
                        <h2 class="rts__section--title">Save the date for Lakeroad Homecoming!</h2>
                        <p class="rts__section--description">Calling all ’4s and ’9s! It’s time to reunite with your
                            classmates on November 24–27, {{now()->year}}</p>
                    </div>
                </div>
            </div>
            <!-- banner image -->
            <div class="row">
                <div class="col-sm-12">
                    <div class="alumni__banner__image">
                        <img src="{{asset('assets/images/gallery/ev1.jpg')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="rts__single--event v__3">
                        <div class="rts__single--event--thumb">
                            <a href="#">
                                <img src="{{asset('assets/images/gallery/alu1.jpg')}}" alt="event">
                            </a>
                        </div>
                        <div class="rts__single--event--meta">
                            ...
                            <h5 class="rts__single--event--meta--title">
                                <a href="#">
                                    Edu Fest {{now()->year}}: Igniting Minds Off on
                                    Transforming Lives </a>
                            </h5>
                            <a href="#" class="rts__round--btn">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="rts__single--event v__3">
                        <div class="rts__single--event--thumb">
                            <a href="#">
                                <img src="{{asset('assets/images/gallery/alu2')}}" alt="event">
                            </a>
                        </div>
                        <div class="rts__single--event--meta">
                            <div class="rts__single--event--meta--dl">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="rts__single--event v__3">
                        <div class="rts__single--event--thumb">
                            <a href="#">
                                <img src="{{asset('assets/images/gallery/alu3.jpg')}}" alt="event">
                            </a>
                        </div>
                        <div class="rts__single--event--meta">
                            <div class="rts__single--event--meta--dl">
                ...
                <div class="col-xl-5 col-lg-6 col-md-6 col-sm-11">
                    <div class="left__side">
                        <div class="rts__section--wrapper v__7">
                            <h2 class="rts__section--title">Stories of Lakeroad Student</h2>
                            <p class="rts__section--description">Embark on a journey of knowledge, discovery, and growth at Lakeroad University. Our admissions process is designed identify bright, motivated individuals who are eager contribute to our dynamic academic community.</p>
                        </div>
                        <div class="left__side__image">
                            <img src="{{asset('assets/images/gallery/alu4.jpg')}}" alt="alumni">
                            <h5 class="left__side__title">Voices of Victory: Lakeroad Student Stories</h5>
                ...
                <div class="col-lg-6 col-md-6 offset-xl-1 col-sm-11">
                    <div class="right__side">
                        <div class="right__side__image">
                            <img src="{{asset('assets/images/gallery/alu5.jpg')}}" alt="alumni">
                        </div>
                        <h5 class="right__side__title">Unveiling Lakeroad: Inspiring Student Stories</h5>
                        <p class="right__side__description">Delve into the heartfelt narratives of Lakeroad students, where each story resonates with triumph, resilience, and personal growth. From academic achievements to life-changing experiences, these stories illuminate.</p>
...
{{--                    <h2 class="rts__section--title">School's Reunion Gallery</h2>--}}
{{--                </div>--}}
{{--            </div>--}}
