                    ...
                    <div class="header__content">
                        <div class="header__content__top">
                            <div class="header__content__top__left">
                                <a href="#"><i
                                        class="fa-classic fa-light fa-location-dot"></i> {{ contactData()['address'] }}
                                </a>
                            </div>
                            <div class="header__content__top__right">
                                <div class="follow_us">
                                    ...
                                    <div>
                                        <a href="https://www.facebook.com/LRPTAS" target="_blank"><i
                                ...
                                <div class="header__right--item">
                                    ...
                                    <div id="cart-trigger" class="cart__trigger"
                                         style="margin-left: 20px; cursor: pointer; position: relative;">
                                        <i class="fa-regular fa-cart-shopping"></i>
                                        <span class="cart-count"
                                              style="position: absolute; top: -10px; right: -10px; background: var(--rt-primary, #890C25); color: #fff; border-radius: 50%; width: 20px; height: 20px; display: flex; align-items: center; justify-content: center; font-size: 10px; font-weight: 700;">0</span>
                                    </div>
                                </div>
                            </div>
                        </div>
